...
@Config
@TeleOp(name = "Main_RedAlliance")
public class Main_RedAlliance extends LinearOpMode {
            ...
            while (opModeIsActive()) {
                ...
                Intake.set(
                        (gamepad2.left_bumper  ? 1 : 0) -
                                ...
                                ((Objects.equals(ActualColor, "blue")) ? 1: 0) * 2
                );

                Swing.set(-SwingSlidePID.calculate(Swing.getCurrentPosition()) * 0.7);
