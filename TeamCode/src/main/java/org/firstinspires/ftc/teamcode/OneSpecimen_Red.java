...
@Autonomous(name = "One_Specimen_AnyAlliance")
public class OneSpecimen_Red extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch(autonomous){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    setSlider_Setpoint(IN_THE_MIDDLE-200);
                    break;
                case 3:
            ...
            if(PidZ.getSetPoint() == 90){
                m_Drive.driveRobotCentric(
                        ...
                        PidZ.calculate(getAngle(odometry.getPose().getRotation().getDegrees()))*0.45
                );
